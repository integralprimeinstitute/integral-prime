    ...
    <div className="bg-white" id="getintouch">
      <div className="max-w-400 my-0 mx-auto p-[100px_20px]">
        ...
        <div className='flex flex-col lg:flex-row gap-[60px] items-center'>
          <div className='flex-auto lg:flex-1 w-full'>
          ...
          <div className="bg-brand-gold-100 border w-full lg:w-[600px] border-brand-gold-200 rounded-[20px] h-[400px] overflow-hidden mt-[10px]lg:mt-[50px] self-center">
            <iframe
