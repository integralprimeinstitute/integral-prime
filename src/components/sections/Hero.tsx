  ...
  return (
    <div className='bg-brand-navy w-full bg-[radial-gradient(circle,#2d3b75_10%,transparent_11%)] bg-size-[2em_2em] opacity-100'>
        <div className='max-w-400 my-0 mx-auto p-[70px_20px] md:p-[100px_20px]'>
            ...
            <div className='flex flex-col md:flex-row gap-5 justify-between item-center'>
                ...
                <div className='w-full sm:w-[360px] max-w-full self-center'>
                    <CoursesCard 
                        title="Our Courses"
                        items={courses}
                        blockIcon={<CircleCheckBig size={18} />}
                        blockTitle="Admission Open"
                        blockSubtitle="2026-27 Batch · Limited Seats"
                    />
                </div>
            </div>
        </div>
